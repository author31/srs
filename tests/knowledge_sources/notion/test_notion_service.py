...
from tests.conftest import db_session, notion_test_config, override_get_db_session
...
class TestNotionService:
    ...
    def test_query_notion_database_success(self, db_session, notion_test_config):
        ...
        result = notion_service.query_notion_database(database_id, payload, headers=headers)
    ...
    def test_query_notion_database_error(self, db_session):
        ...
        result = notion_service.query_notion_database(invalid_database_id, None)
    ...
    def test_fetch_all_blocks_recursive_success(self, db_session, notion_test_config):
        ...
        result = notion_service.fetch_all_blocks_recursive(block_id, headers=headers)
